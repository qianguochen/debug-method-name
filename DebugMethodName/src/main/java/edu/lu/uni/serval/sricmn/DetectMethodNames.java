...
public class DetectMethodNames {
	...
	public void evaluate2(List<MethodInfo> renamedOldMethodInfo, List<MethodInfo> renamedNewMethodInfo, List<MethodInfo> trainingMethodInfo, 
		...
		System.out.println("Accuracy: " + FORMAT.format(((double)oldPredictedNum1_1 / size4) * 100) + "%");
		System.out.println("oldPredictedNum1_1:"+oldPredictedNum1_1+"==size3:"+size3+"==oldPredictedNum1:"+oldPredictedNum1+"abs:"+Math.abs(size3 - (oldPredictedNum1 - oldPredictedNum1_1)));
		System.out.println("Recall: "+FORMAT.format(((double)truePositives)/size4));
		eval = new edu.lu.uni.serval.utils.Evaluation(oldPredictedNum1_1, oldPredictedNum1 - oldPredictedNum1_1, size2 - oldPredictedNum1_1, Math.abs(size3 - (oldPredictedNum1 - oldPredictedNum1_1)));
		eval.evaluate();
		System.out.println("R1: Top_5_oldName ");// + oldPredictedNum1_1_5 + " " + oldPredictedNum1_1_5);
		System.out.println("Accuracy: " + FORMAT.format(((double)oldPredictedNum1_1_5 / size4) * 100) + "%");
		System.out.println("oldPredictedNum1_1_5"+oldPredictedNum1_1_5+"==size3:"+size3+"==oldPredictedNum1_5:"+oldPredictedNum1_5);
		eval = new edu.lu.uni.serval.utils.Evaluation(oldPredictedNum1_1_5, oldPredictedNum1_5 - oldPredictedNum1_1_5, size2 - oldPredictedNum1_1_5, Math.abs(size3 - (oldPredictedNum1_5 - oldPredictedNum1_1_5)));
		eval.evaluate();
		System.out.println("R1: Top_1_newName ");// + newPredictedNum1 + " " + newPredictedNum1_1);
		System.out.println("Accuracy: " + FORMAT.format(((double)newPredictedNum1_1 / size4) * 100) + "%");
		eval = new edu.lu.uni.serval.utils.Evaluation(newPredictedNum1_1, newPredictedNum1 - newPredictedNum1_1, size2 - newPredictedNum1_1, Math.abs(size3 - (newPredictedNum1 - newPredictedNum1_1)));
		eval.evaluate();
		System.out.println("R1: Top_5_newName ");// + newPredictedNum1_5 + " " + newPredictedNum1_1_5);
		System.out.println("Accuracy: " + FORMAT.format(((double)newPredictedNum1_1_5 / size4) * 100) + "%");
		eval = new edu.lu.uni.serval.utils.Evaluation(newPredictedNum1_1_5, newPredictedNum1_5 - newPredictedNum1_1_5, size2 - newPredictedNum1_1_5, Math.abs(size3 - (newPredictedNum1_5 - newPredictedNum1_1_5)));
		eval.evaluate();
		System.out.println("R1: Top_1_fullName ");// + numOfFullNames1 + " " + numOfFullNames1_1);
		System.out.println("Accuracy: " + FORMAT.format(((double)numOfFullNames1_1 / size4) * 100) + "%");
		eval = new edu.lu.uni.serval.utils.Evaluation(numOfFullNames1_1, numOfFullNames1 - numOfFullNames1_1, size2 - numOfFullNames1_1, Math.abs(size3 - (numOfFullNames1 - numOfFullNames1_1)));
		eval.evaluate();
		System.out.println("R1: Top_5_fullName ");// + numOfFullNames1_5 + " " + numOfFullNames1_1_5);
		System.out.println("Accuracy: " + FORMAT.format(((double)numOfFullNames1_1_5 / size4) * 100) + "%");
		eval = new edu.lu.uni.serval.utils.Evaluation(numOfFullNames1_1_5, numOfFullNames1_5 - numOfFullNames1_1_5, size2 - numOfFullNames1_1_5, Math.abs(size3 - (numOfFullNames1_5 - numOfFullNames1_1_5)));
		eval.evaluate();
		System.out.println("========================================================================================");
	}
